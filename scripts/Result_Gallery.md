...
Due to Github's security policy, it is not possible to directly upload videos for playback. Specific videos can be downloaded through this [link t2v](https://pai-aigc-photog.oss-cn-hangzhou.aliyuncs.com/easyanimate/asset/v3/t2v.zip).

![Result_t2v](https://pai-aigc-photog.oss-cn-hangzhou.aliyuncs.com/easyanimate/asset/v3/t2v_result.jpg)

Result of i2v:

Due to Github's security policy, it is not possible to directly upload videos for playback. Specific videos can be downloaded through this [link i2v](https://pai-aigc-photog.oss-cn-hangzhou.aliyuncs.com/easyanimate/asset/v3/i2v.zip).
![Result_i2v](https://pai-aigc-photog.oss-cn-hangzhou.aliyuncs.com/easyanimate/asset/v3/i2v_result.jpg)

<details>
<summary>Some prompts of the t2v demo is as follow. Click Here : </summary>
...
Handheld tracking shot at night, following a dirty blue ballon floating above the ground in abandon old European street.
Handheld tracking shot, following a red ballon floating above the ground in abandon street.
...
Handheld camera moving fast, flashlight light, in a white old wall in a old alley at night a black graffiti that spells "EasyAnimate".
Super fast zoom out from the peak of a frozen mountain where a lonely hiker is arriving to the submit.
...
Aerial view shot of a cloaked figure elevating in the sky betweem slyscrapers.
...
A hand pashes milk from a steel milking pot into a cup of coffee on the table, with the kitchen blurred in the background.
Two flowers bloom slowly against a black background, revealing delicate petals and stamens.
A giant panda plays the guitar by the lake.
In the late afternoon, a car is driving along the highway, and the gorgeous sunset and peaceful scenery are reflected in the rear-view mirror.
In close-up, the feathers of a bright blue parrot glint in the light, showing off its unique plumage and vivid colors.
...
extend a video both forward and backward to produce a seamless infinite loop.
