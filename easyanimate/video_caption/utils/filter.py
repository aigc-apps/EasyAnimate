...
def filter(
    ...
    asethetic_score_metadata_path: Optional[str] = None,
    min_asethetic_score: float = 4,
    asethetic_score_siglip_metadata_path: Optional[str] = None,
    min_asethetic_score_siglip: float = 4,
