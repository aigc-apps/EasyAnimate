...
VIDEO_QUALITY_SCORE_SAVED_PATH="datasets/panda_70m/videos_clips/meta_quality_info_siglip.jsonl"
MIN_ASETHETIC_SCORE_SIGLIP=4.0
TEXT_SCORE_SAVED_PATH="datasets/panda_70m/videos_clips/meta_text_info.jsonl"
MIN_TEXT_SCORE=0.02
...
accelerate launch compute_video_quality.py \
    ...
    --saved_freq 10 \
    --saved_path $VIDEO_QUALITY_SCORE_SAVED_PATH \
    --batch_size 4
...
accelerate launch compute_text_score.py \
    ...
    --video_folder $VIDEO_FOLDER  \
    --saved_freq 10 \
    --saved_path $TEXT_SCORE_SAVED_PATH \
    --asethetic_score_siglip_metadata_path $VIDEO_QUALITY_SCORE_SAVED_PATH \
...
python compute_motion_score.py \
    ...
    --video_folder $VIDEO_FOLDER \
    --saved_freq 10 \
    --saved_path $MOTION_SCORE_SAVED_PATH \
    --n_jobs 8 \
    --text_score_metadata_path $TEXT_SCORE_SAVED_PATH \
